...
/**
 * get_environ - Returns a copy of the environment variables as an array
...
{
	/* If env variables have not been set or have been changed, update them. */
 ...
 * Return: 0 if the env var was successfully added or updated, else 1.
 */
